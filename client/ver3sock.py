...
class QuizApp:
    ...
    def init_add_question_frame(self):
        ...
        # tk.Label(self.add_question_frame, text="Subject").pack()
        # self.subject_entry = tk.Entry(self.add_question_frame)
    ...
    def init_take_quiz_frame(self):
        ...
        # tk.Label(self.take_quiz_frame, text="Subject").pack()
        # self.quiz_subject_entry = tk.Entry(self.take_quiz_frame)
        # self.quiz_subject_entry.pack()
    ...
    def start_quiz(self):
        # subject = self.quiz_subject_entry.get()
    ...
    def submit_answer(self, selected_answer):
        question_id = self.current_question_id
        sio.emit('submit_answers', {'answers': [{'question_id': question_id, 'selected_answer': selected_answer}]})
